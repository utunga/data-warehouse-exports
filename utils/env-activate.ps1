...
# MKT 2016 Actually we just hard code this based on shard dev env
#          (alternative is to copy these files into the ananconda scripts dir which is just as bad)
$anacondaInstallPath = 'C:\Anaconda3' #(Get-Item $PSScriptRoot).parent.FullName
